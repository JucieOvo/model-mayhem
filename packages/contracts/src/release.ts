...
export const ContentInstallationSchema = z
  .object({
    ...
    balanceCommit: z.string().min(1),
    balanceTreeHash: z.string().regex(/^[a-f0-9]{64}$/),
    balanceManifestHash: z.string().regex(/^[a-f0-9]{64}$/),
    installationTreeHash: z.string().regex(/^[a-f0-9]{64}$/),
...
export const UpdateStatusSchema = z
  .object({
    ...
    contentBranch: z.string().nullable(),
    balanceBranch: z.string().nullable(),
    channel: UpdateChannelSchema,
    checkOnStart: z.boolean(),
    autoInstall: z.boolean(),
    controlTokenRequired: z.boolean(),
    active: ContentInstallationSchema.nullable(),
    pendingContentCommit: z.string().nullable(),
    pendingBalanceCommit: z.string().nullable(),
    pendingContentVersion: z.string().nullable(),
    pendingBalanceVersion: z.string().nullable(),
...
export const DiagnosticSummarySchema = z
  .object({
    ...
    balanceVersion: z.string().min(1),
    balanceCommit: z.string().min(1),
    dataDirectoryConfigured: z.boolean(),
    agentRuntimeDirectoryConfigured: z.boolean(),
    logDirectoryConfigured: z.boolean(),
